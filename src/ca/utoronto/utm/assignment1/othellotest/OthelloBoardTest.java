...
public class OthelloBoardTest {
	...
	public void setUp() throws Exception {
		...
		//System.out.println("P2 put on (2,5)" + board.toString());		//delete later
		
		board.move(2, 6, OthelloBoard.P1);
		
		//System.out.println("P1 put on (2,6)" + board.toString());		//delete later
		
		board.move(2, 3, OthelloBoard.P2);
		
		//System.out.println(board.toString());			//For my purposes, remember to remove this after
	...
	System.out.println(board.toString());				//DELETE LATER THIS IS FOR MY OWN PURPOSES
	}
}
